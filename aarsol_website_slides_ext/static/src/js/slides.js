odoo.define('aarsol_website_slides_ext.slides', function (require) {
'use strict';
...
odoo.define('aarsol_website_slides_ext.slides_embed', function (require) {
'use strict';

var publicWidget = require('web.public.widget');
require('aarsol_website_slides_ext.slides');
