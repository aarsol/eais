odoo.define('aarsol_website_slides_ext.quiz.question.form', function (require) {
'use strict';
...
var QuestionFormWidget = publicWidget.Widget.extend({
    ...
    xmlDependencies: ['/aarsol_website_slides_ext/static/src/xml/slide_quiz_create.xml'],
    events: {
