...
var questions_time_option = $parent.data('questions_time_option');
var auto_next_ques = $parent.data('auto_next_ques');
...
var updateTimer = function () {
    ...
    if (timeLeft >= 0) {
        ...
        if (questions_time_option == 'each_question'){

                if (auto_next_ques == 'True'){
                    $('.js_surveyform').submit();
                }
                else{
                    if (document.getElementById('is_last_question').value == 'True'){
                        $('.js_surveyform').submit();
                    }
                    else{
