odoo.define('aarsol_website_slides_ext.fullscreen.ext', function (require) {
    ...
    Fullscreen.include({
        xmlDependencies: (Fullscreen.prototype.xmlDependencies || []).concat(
            ["/aarsol_website_slides_ext/static/src/xml/website_slides_fullscreen.xml"]
        ),
        ...
        _renderSlide: function (){
            ...
            if (this.get('slide').type === "certification"){
                $content.html(QWeb.render('website.slides.fullscreen.certification2',{widget: this}));
            }
            if (this.get('slide').type === "assignment"){
                $content.html(QWeb.render('website.slides.fullscreen.content2',{widget: this}));
            }
