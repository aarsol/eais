odoo.define('aarsol_website_slides_ext.channel_tag.add', function (require) {
'use strict';
...
publicWidget.registry.websiteSlidesTag = publicWidget.Widget.extend({
    ...
    xmlDependencies: ['/aarsol_website_slides_ext/static/src/xml/website_slides_channel_tag.xml'],
    events: {
