odoo.define('aarsol_website_slides_ext.quiz.ext', function (require) {
    'use strict';
    ...
    var QWeb = core.qweb;
    var Fullscreen = require('website_slides.quiz');

    var CourseJoinWidget = require('website_slides.course.join.widget').courseJoinWidget;
    var QuestionFormWidget = require('aarsol_website_slides_ext.quiz.question.form');
    var SlideQuizFinishModal = require('aarsol_website_slides_ext.quiz.finish');
    ...
    xmlDependencies: (Fullscreen.prototype.xmlDependencies || []).concat(
        ["/aarsol_website_slides_ext/static/src/xml/slide_quiz.xml"]
    ),
    ...
    publicWidget.registry.websiteSlidesQuizNoFullscreen = publicWidget.Widget.extend({
        ...
        start: function () {
            ...
            this.$('.o_wslides_js_lesson_quiz').each(function () {
                ...
                defs.push(new Fullscreen(self, slideData, channelData, slideData.quizData).attachTo($(this)));
            });
            return Promise.all(defs);
        },
