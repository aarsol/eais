odoo.define('aarsol_website_slides_ext.course.join.widget', function (require) {
'use strict';
...
var CourseJoinWidget = publicWidget.Widget.extend({
    ...
    xmlDependencies: ['/aarsol_website_slides_ext/static/src/xml/slide_course_join.xml'],
    events: {
